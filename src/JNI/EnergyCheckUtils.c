...
Java_jRAPL_JNIAccess_profileInit(JNIEnv *env, jclass jcls) {
...
Java_jRAPL_JNIAccess_energyStatCheck(JNIEnv *env, jclass jcls) {
	char ener_info[512];
...
JNIEXPORT void JNICALL
Java_jRAPL_JNIAccess_profileDealloc(JNIEnv * env, jclass jcls) {
	ProfileDealloc();
}
